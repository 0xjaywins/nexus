...
export const CyberpunkButton = React.forwardRef<HTMLButtonElement, CyberpunkButtonProps>(
  ({ variant = "cyan", size = "default", glitch = true, className, children, ...props }, ref) => {
    ...
    const getButtonStyles = () => {
      const baseStyles = "relative overflow-hidden transition-all duration-300 border flex justify-center items-center px-4 py-2"
      ...
      const variantStyles = {
        ...
        magenta: "border-neon-magenta text-neon-magenta hover:bg-neon-magenta/5 neon-border-magenta bg-[#150815]",
        gradient:
    ...
    return (
      ...
      >
        {/* Content */}
        <span className={cn("relative z-10", glitch && "glitch-hover")}>{children}</span>
